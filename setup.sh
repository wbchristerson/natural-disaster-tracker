psql -c "
    ...
    INSERT INTO observers (id, username, photograph_url)
        VALUES (1, 'watcher', 'https://www.toocool2betrue.com/content/142065/e473256bce80e755d09b347924d96fd9.jpg'),
               (2, 'weather reporter', 'https://cdn.vox-cdn.com/thumbor/tZLxhLAWoEFRpf0pe-CirjvF0XY=/1400x788/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/15788040/20150428-cloud-computing.0.1489222360.jpg');
